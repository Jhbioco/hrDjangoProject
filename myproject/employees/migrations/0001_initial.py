# Generated by Django 2.1.5 on 2019-02-10 02:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('att_file', models.FileField(upload_to='', verbose_name='files/%Y/%m/%d')),
            ],
        ),
        migrations.CreateModel(
            name='Category',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('doc_number', models.IntegerField(blank=True)),
        ...
        migrations.AddField(
            ...
            name='document',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='employees.Document'),
        ),
        migrations.AddField(
            model_name='attachment',
            name='employee',
